import RegisterForm from "./dang-ky/register-form";

export const metadata = {
  title: "Food Culture & Aesthetic — Đăng ký học phần",
  description:
    "Học phần Food Culture & Aesthetic — Trường ĐH Ngoại thương, Đào tạo Quốc tế. Đăng ký ghi danh trực tuyến.",
};
...
export default function HomePage() {
  return (
    <main className="mx-auto w-full max-w-3xl px-6 py-14">
      {/* Thanh trên: thương hiệu + link đăng nhập quản trị */}
      <div className="mb-10 flex items-center justify-between">
        <span className="eyebrow">Course · F-NU-10</span>
        <a
          href="/login"
          className="text-sm text-sage transition hover:text-gold"
        >
          Đăng nhập quản trị →
        </a>
      </div>
      ...
      <footer className="mt-12 border-t border-gold/15 pt-6 text-center text-xs text-sage">
        © Food Culture &amp; Aesthetic · Trường ĐH Ngoại thương — Đào tạo Quốc tế
      </footer>
    </main>
  );
}
